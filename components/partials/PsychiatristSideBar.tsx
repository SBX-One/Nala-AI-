    ...
    <div className="flex flex-col w-fit h-screen bg-surface-background border-r border-border-default px-4 py-8 justify-between">
      <div>
        ...
        <div className="flex items-center gap-4 mb-10">
          <Image src={NalaLogo} alt="Nala-Logo" priority className="w-15" />
          <div className="flex flex-col gap-1">
            <h1 className="text-body-xl-semibold text-text-action">Nala</h1>
        ...
        <nav className="flex flex-col gap-2">
          {navItems.map((item) => (
            <NavLink key={item.label} item={item} currentPath={path} />
          ))}
        </nav>
      </div>

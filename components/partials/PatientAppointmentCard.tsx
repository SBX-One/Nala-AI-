...
const PatientAppointmentCard: React.FC<PatientAppointmentCardProps> = ({
  ...
  const badgeClasses = {
    ...
    "light-blue":
      "bg-surface-primary-light text-text-action border border-border-action",
  };

  return (
    <div
      className={`flex flex-col p-4 rounded-xl border ${
        isHighlighted || type === "waiting"
          ? "border-2 border-border-warning"
          : config.borderClass
        ...
        <div className="flex gap-4.5 items-center">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              <p className="text-body-lg-semibold text-text-heading">{name}</p>
